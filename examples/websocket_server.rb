...
# Example WebSocket server implementation using VectorMCP
...
server = VectorMCP::Server.new(
  name: "VectorMCP::WebSocketExampleServer",
  version: "0.0.1"
)
...
begin
  puts "Starting VectorMCP WebSocket server on port #{port}..."
  server.start_websocket(port: port)
rescue Interrupt
